...
- 2026-07-24: AUTO-001 — Scaffold local CLI and package metadata (DONE)
- 2026-07-24: AUTO-002 — Parse autonomous plan task headings (DONE)
- 2026-07-24: AUTO-003 — Add deterministic eligible-task selection (DONE)
- 2026-07-24: AUTO-004 — Produce a dry-run repository report (DONE)
- 2026-07-24: AUTO-005 — Document repository policy format (DONE)
- 2026-07-24: AUTO-006 — Add contributor development guidance (DONE)
- 2026-07-24: AUTO-007 — Parse repository policy sections (DONE)
- 2026-07-24: AUTO-008 — Surface policy readiness in dry-run reports (DONE)
- 2026-07-24: AUTO-009 — Add roadmap structure linting (DONE)
- 2026-07-24: AUTO-010 — Document command output contracts (DONE)
- 2026-07-24: AUTO-011 — Record local run summaries without execution (DONE)
- 2026-07-24: AUTO-012 — Preview local run summaries without writing files (DONE)
- 2026-07-24: AUTO-013 — Document repository health inventory scope (DONE)
- 2026-07-24: AUTO-014 — Implement read-only repository health inventory (DONE)
- 2026-07-24: AUTO-015 — Detect metadata consistency drift (DONE)
- 2026-07-24: AUTO-016 — Capture and replay session context for handoff (DONE)
- 2026-07-24: AUTO-017 — Generate project context briefing (DONE)
- 2026-07-24: AUTO-018 — Scaffold forge metadata into any repository (DONE)
- 2026-07-24: AUTO-019 — Validate changed files against policy boundaries (DONE)
- 2026-07-24: AUTO-020 — Run validation commands and report results (DONE)
- 2026-07-24: AUTO-021 — Execute one autonomous improvement cycle (DONE)
- 2026-07-24: AUTO-022 — Bridge plan tasks to Forgejo issues (DONE)
- 2026-07-24: AUTO-023 — Safe auto-commit with pre-flight checks (DONE)
- 2026-07-24: AUTO-024 — View run history (DONE)
- 2026-07-24: AUTO-025 — Full autonomous pipeline command (DONE)
- 2026-07-24: AUTO-026 — Mark task status from CLI (DONE)
- 2026-07-24: AUTO-027 — Quick at-a-glance status (DONE)
- 2026-07-24: AUTO-028 — Combined verification check (DONE)
- 2026-07-24: AUTO-029 — Add tasks to plan from CLI (DONE)
- 2026-07-24: AUTO-030 — Aggregate run history metrics (DONE)
- 2026-07-24: AUTO-031 — Task filtering (DONE)
- 2026-07-24: AUTO-032 — JSON export (DONE)
- 2026-07-24: AUTO-033 — Push stage in pipeline (DONE)
- 2026-07-24: AUTO-034 — Hash-linked local run reports (DONE)
- 2026-07-24: AUTO-035 — Read-only Forgejo orphan-issue report (DONE)
- 2026-07-24: AUTO-036 — Cross-repo session handoff aggregation (DONE)
- 2026-07-24: AUTO-037 — `forge watch` periodic check mode (DONE)
- 2026-07-24: AUTO-038 — Diagnose environment issues before a run (DONE)
- 2026-07-24: AUTO-039 — Repo-level config defaults (DONE)
- 2026-07-24: AUTO-040 — Prevent concurrent forge run/pipeline collisions (DONE)

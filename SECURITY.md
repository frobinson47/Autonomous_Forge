...
- **Validation output is persisted without secret redaction.** Run summaries under `.forge/runs/` (gitignored) capture stdout/stderr from the validation command verbatim. If a test or tool prints a credential, it can end up on disk.
